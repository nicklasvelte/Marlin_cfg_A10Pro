...
#define PROBE_OFFSET_Z_MAX 0           // Added by config.ini 2025-03-09 09:51:13
#define PROBE_OFFSET_Z_MIN -5          // Added by config.ini 2025-03-09 09:51:13
...
#define STRING_CONFIG_H_AUTHOR "(Phr3d13, Geeetech A10 default)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "A10Pro"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 99.84
  #define DEFAULT_bedKi 15.05
  #define DEFAULT_bedKd 441.68
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 31, -40, -2.75 }
...
#define Z_CLEARANCE_MULTI_PROBE Z_CLEARANCE_BETWEEN_PROBES     // (mm) Z Clearance between multiple probes
